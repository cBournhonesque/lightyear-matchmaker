...
//!
//! - `request_play_once` for simple one-shot request-play workflows.
//! - `LightyearMatchmakerClientPlugin` for a persistent websocket session that
//!   supports request-play, lobby create/join/ready messages, connection-grant
//!   state, reconnect reporting, and structured errors.
